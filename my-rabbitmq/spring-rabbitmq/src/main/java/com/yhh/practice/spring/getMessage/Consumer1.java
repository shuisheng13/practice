...
public class Consumer1 {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            channel.exchangeDeclare(Constant.GET_FACTION_EXCHANGE_NAME_03,
            ...
            channel.queueBind(queueName,
                    Constant.GET_FACTION_EXCHANGE_NAME_03, severity);
            ...
            while (true){
                ...
                if(null!=getResponse){
                    ...
                    System.out.println("消费者消费次数 【"+atomicInteger.incrementAndGet()+"】"+getResponse);
